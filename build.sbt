...
lazy val libs =
  ...
  .addJVM(name = "lihua",                 version = "0.35-SNAPSHOT",   org ="com.iheart", "lihua-mongo", "lihua-cache", "lihua-crypt", "lihua-core", "lihua-dynamo", "lihua-dynamo-testkit", "lihua-play-json")
  ...
  .add(   name = "play",                  version = "2.8.0",  org = "com.typesafe.play")
  ...
  .add(   name = "http4s",                version = "0.21.0-RC4")
