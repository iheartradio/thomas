...
lazy val libs =
  org.typelevel.libraries
    ...
    .addJava(name ="log4j-core",            version = "2.22.0", org = "org.apache.logging.log4j")
    .addJava(name ="logback-classic",       version = "1.4.11",  org = "ch.qos.logback")
...
lazy val stress = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      "io.gatling.highcharts" % "gatling-charts-highcharts" % "3.10.4" % Test,
